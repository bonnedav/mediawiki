...
$wgAddGroups['steward'] = array( 'sysop', 'bureaucrat', 'steward', 'checkuser', 'exampleuser', 'oversight' );
$wgRemoveGroups['steward'] = array( 'sysop', 'bureaucrat', 'steward', 'checkuser', 'exampleuser', 'oversight' );
